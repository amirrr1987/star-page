...
function canvasApp() {
    ...
    function init() {
        ...
        sphereCenterX = 0;
        sphereCenterY = 0;
        sphereCenterZ = -5 - testobj.sphereRad;
    ...
    function onTimer() {
        ...
        if (count >= wait) {
            ...
            for (i = 0; i < numToAddEachFrame; i++) {
                ...
                x0 = testobj.sphereRad * Math.sin(phi) * Math.cos(theta);
                y0 = testobj.sphereRad * Math.sin(phi) * Math.sin(theta);
                z0 = testobj.sphereRad * Math.cos(phi);
